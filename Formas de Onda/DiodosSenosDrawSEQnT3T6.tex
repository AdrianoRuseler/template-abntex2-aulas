...
% Vamos tentar algo com alpha

\def \tryalpha {} % angulo de disparo em radiandos
...
%\addplot [mark=none, vaccolor,ultra thick]{sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vac
\addplot [mark=none, vcacolor,ultra thick][domain=3*pi/2:11*pi/6]{-sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vca
\addplot [mark=none, vcacolor,ultra thick][domain=7*pi/2:23*pi/6]{-sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vca
%\addplot [mark=none, vcacolor,ultra thick][domain=5*pi/2:17*pi/6]{-sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vca
%\addplot [mark=none, vcacolor,ultra thick][domain=pi/2:5*pi/6]{-sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vca

\addplot [mark=none, black,ultra thick][domain=pi/6:3*pi/2]{0}; % Vca
\addplot [mark=none, black,ultra thick][domain=13*pi/6:7*pi/2]{0}; % Vca

\draw[mark=none, black,ultra thick] (axis cs:4.712,0) -- (axis cs:4.712,1.225);
\draw[mark=none, black,ultra thick] (axis cs:6.8,0) -- (axis cs:6.8,1.225);
\draw[mark=none, black,ultra thick] (axis cs:0.52,0) -- (axis cs:0.52,1.225);
\draw[mark=none, black,ultra thick] (axis cs:11,0) -- (axis cs:11,1.225);

%\addplot [mark=none, vcbcolor,ultra thick] {sqrt(2)*cos(deg(x))}; % Vcb

\addplot [mark=none, vcbcolor,ultra thick][domain=0:pi/6] {sqrt(2)*cos(deg(x))}; % Vcb
\addplot [mark=none, vcbcolor,ultra thick][domain=11*pi/6:13*pi/6] {sqrt(2)*cos(deg(x))}; % Vcb
\addplot [mark=none, vcbcolor,ultra thick][domain=23*pi/6:4*pi] {sqrt(2)*cos(deg(x))}; % Vcb
...
%\addplot [mark=none, vabcolor,ultra thick] {-sqrt(2)*sin(deg(x+(7*3.1415/6)))}; % Vab
...
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,vcacolor}]64:{$i_{ca}$}}] at (axis cs:5.24,1.42){}; % Print curve tip

\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,vcbcolor}]64:{$i_{cb}$}}] at (axis cs:6.28,1.42){}; % Print curve tip
