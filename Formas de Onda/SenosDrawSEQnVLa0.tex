...
\addplot [mark=none, vbccolor,ultra thick][domain=5*pi/6:7*pi/6]{-sqrt(2)*cos(deg(x))}; % Vbc
\addplot [mark=none, vbccolor,ultra thick][domain=17*pi/6:19*pi/6]{-sqrt(2)*cos(deg(x))}; % Vbc



\addplot [mark=none, vbacolor,ultra thick][domain=7*pi/6:3*pi/2]{sqrt(2)*sin(deg(x+(7*3.1415/6)))}; % Vba
\addplot [mark=none, vbacolor,ultra thick][domain=19*pi/6:7*pi/2]{sqrt(2)*sin(deg(x+(7*3.1415/6)))}; % Vba
...
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,vbacolor}]64:{$v_{ba}$}}] at (axis cs:4.188,1.42){}; % Print curve tip
