...
\begin{document}
 ...
 \begin{groupplot}[group style={group name=simviewplots, group size= 1 by 2, vertical sep=0.25cm,  horizontal sep=0.25cm}]   
\nextgroupplot[
Axis Style,
grid=major,
...
\addplot [mark=none, vabcolor,ultra thick] {sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vab
\addplot [mark=none, vbacolor,ultra thick] {-sqrt(2)*sin(deg(x+(11*3.1415/6)))}; % Vba
%\addplot [mark=none, vbccolor,ultra thick] {sqrt(2)*cos(deg(x))}; % Vbc
%\addplot [mark=none, vcbcolor,ultra thick] {-sqrt(2)*cos(deg(x))}; % Vcb
%\addplot [mark=none, vcacolor,ultra thick] {sqrt(2)*sin(deg(x+(7*3.1415/6)))}; % Vca
%\addplot [mark=none, vaccolor,ultra thick] {-sqrt(2)*sin(deg(x+(7*3.1415/6)))}; % Vac
